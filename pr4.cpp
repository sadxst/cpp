...
public:
    ...
    void print(int currentYear) const {
        cout << "\n[ Холодильники з простроченою гарантією ]\n";
        bool found = false;
...
class DerivedProductManager : public BaseProductManager {
public:
    DerivedProductManager(int size) : BaseProductManager(size) {}
...
int main() {
    ...
    DerivedProductManager manager(n);
    manager.input();
    cout << "\nДо сортування:";
    manager.print();
